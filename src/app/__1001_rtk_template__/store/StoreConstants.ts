...
export const baseI_3_template_PerPage = 2;
export const queryParams = { q: '', page: 1, limit: baseI_3_template_PerPage };
export const pageLimitArr: number[] = [baseI_3_template_PerPage, 10, 50, 100, 200];
